...
import HexagonalAnim from "../HexagonalAnim/HexagonalAnim";
import Loader from "react-loader-spinner";
import firebase from "../firebase";
import ScheduledLiveNavBar from "../NavBars/ScheduledLiveNavBar";
import CircleTimer from "./CircleTimer";
export default function ScheduledLiveHexagonalAnim({ match }) {
  ...
  useEffect(() => {
    ...
    const todoRef = firebase
      .database()
      .ref("/HexagonalAnim/" + match.params.id)
      .once("value")
      .then((snapshot) => {
