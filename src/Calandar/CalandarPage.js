...
function CalandarPage() {
  ...
  const handleFireBaseUpload = () => {
    ...
    if (!livelink) {
      ...
      setlivelink("http://localhost:3000/live/calandar/" + newKey);
      setpreviewlink("/live/calandar/" + newKey);
  ...
  const tourConfig = [
    {
      ...
      content: `Choose an image from you local device to be displayed on the Calandar.`,
    },
    {
